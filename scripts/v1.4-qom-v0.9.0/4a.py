...
looper = wrap_looper(SystemClass=None, params=params, func=func_rat_var_min, looper='XLooper', file_path_prefix='data/v1.4-qom-v0.9.0/4a_n=10')
rat, var_0 = np.transpose(looper.results['V']).tolist()

# high thermal phonons
params['system']['ns'][1] = 1000.0
looper = wrap_looper(SystemClass=None, params=params, func=func_rat_var_min, looper='XLooper', file_path_prefix='data/v1.4-qom-v0.9.0/4a_n=1000')
