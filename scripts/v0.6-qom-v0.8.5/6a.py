...
# looper
looper = wrap_looper(SystemClass=MM_01, params=params, func='mav', looper='XYLooper', file_path_prefix='data/v0.6-qom-v0.8.5/6a')
xs = looper.axes['X']['val']
vs = [[v[0] for v in V] for V in looper.results['V']]
...
plotter.update(xs=xs, vs=- 10 * np.log10([vs[0], vs[1], [0.5] * len(xs)]))
plotter.show(True)