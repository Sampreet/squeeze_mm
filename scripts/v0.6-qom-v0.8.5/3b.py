...
looper = wrap_looper(SystemClass=None, params=params, func=func_rat_n_b_min, looper='XLooper', file_path_prefix='data/v0.6-qom-v0.8.5/3b_n=10')
rat, n_b_0 = np.transpose(looper.results['V']).tolist()

# high thermal phonons
params['system']['ns'][1] = 1000.0
looper = wrap_looper(SystemClass=None, params=params, func=func_rat_n_b_min, looper='XLooper', file_path_prefix='data/v0.6-qom-v0.8.5/3b_n=1000')
